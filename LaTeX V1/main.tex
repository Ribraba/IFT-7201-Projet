...
\title{Analyse Préliminaire - IFT-7201}
...
{Ibrahim R. HADJ-ARAB}\thanks{Use footnote for providing further
...
\author[1]{%
	%\href{https://orcid.org/0000-0000-0000-0000}
    {\usebox{\orcid}\hspace{1mm}Ibrahim R. HADJ-ARAB\thanks{\texttt{brahim-rabah.hadj-arab.1@ulaval.ca}}}%
}
\author[1,2]{%
	%\href{https://orcid.org/0000-0000-0000-0000}%
    {\usebox{\orcid}\hspace{1mm}Khalil EN NOUAARY\thanks{\texttt{khalil.en-nouaary.1@ulaval.ca}}}%
}
\affil[1]{Faculté des sciences et de génie, Université Laval, Québec, QC G1V 0A6}
\affil[2]{Faculté des sciences et de génie, Université Laval, Santa Québec, QC G1V 0A6}
\fi
