...
\textbf{Moyen} ($4\times4$, stochastique, 4 trous en colonne). Topologie identique à \textit{Facile} ; seul \texttt{is\_slippery} change. Ce cas isole rigoureusement l'effet de la stochasticité : toute dégradation de performance est attribuable uniquement au non-déterminisme, non à la topologie de la grille.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\linewidth]{../figures/policy_hard.png}
